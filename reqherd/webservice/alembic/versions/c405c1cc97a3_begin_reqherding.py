...
def upgrade():
    ...
    op.create_table(
        ...
        sa.Column("modified_date", sa.DateTime(), nullable=False),
        sa.Column("doc_prefix", sa.Unicode(length=10), nullable=False),
        sa.Column("system_requirement_id", sa.BigInteger(), nullable=False),
    ...
    op.create_table(
        ...
        sa.Column("modified_date", sa.DateTime(), nullable=False),
        sa.Column("doc_prefix", sa.Unicode(length=10), nullable=False),
        sa.Column("hardware_requirement_id", sa.BigInteger(), nullable=False),
        sa.ForeignKeyConstraint(
    ...
    op.create_table(
        ...
        sa.Column("modified_date", sa.DateTime(), nullable=False),
        sa.Column("doc_prefix", sa.Unicode(length=10), nullable=False),
        sa.Column("software_requirement_id", sa.BigInteger(), nullable=False),
        sa.ForeignKeyConstraint(
